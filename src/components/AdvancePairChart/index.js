...
const AdvancePairChart = ({ tokenAddress, symbolName, base, pair }) => {
  ...
  return <div id="tv_chart_container" className={'AdvancePairChart'} style={{ marginTop: '10px', height: '100%' }} />
}

export default AdvancePairChart
